...
return [
    ...
    'filename' => '/home/vagrant/Projects/2nomadstest/wiki/user/plugins/simplesearch/languages.yaml',
    'modified' => 1461784105,
    'data' => [
        'en' => [
            'PLUGIN_SIMPLESEARCH' => [
        ...
        'fr' => [
            'PLUGIN_SIMPLESEARCH' => [
                ...
                'SEARCH_RESULTS_SUMMARY_SINGULAR' => 'Recherche: <strong>%s</strong> trouvé un résultat',
                'SEARCH_RESULTS_SUMMARY_PLURAL' => 'Recherche: <strong>%s</strong> trouvé %s résultats'
            ]
        ],
        'zh' => [
            'PLUGIN_SIMPLESEARCH' => [
