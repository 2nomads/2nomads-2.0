...
return [
    ...
    'filename' => '/home/vagrant/Projects/2nomads/user/plugins/admin/languages/it.yaml',
    'modified' => 1464893278,
    'data' => [
        'PLUGIN_ADMIN' => [
            ...
            'NEEDS_GRAV_1_1' => '<i class="fa fa-exclamation-triangle"></i> <strong>Stai usando Grav v%s</strong>. È necessario aggiornare all\'ultima versione <strong>Grav v1.1.x</strong> al fine di garantire la compatibilità. Potrebbe essere necessario passare alle release di <strong>testing</strong> nella configurazione del sistema.',
